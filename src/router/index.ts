    ...
    // 系列介紹
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('../views/SeriesIntroduction/ThemeDeckDetail.vue')
        },
        {
          path: 'plugin',
          name: 'plugin',
        ...
        },
        {
          path: 'plugin/:id',
          name: 'plugin_detail',
          component: () => import('../views/SeriesIntroduction/PluginDetail.vue')
        },
      ]
    },
    // 泛用卡介紹
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('../views/UsefulCardIntroduction/SingleCardDetail.vue')
        },
        {
          path: 'strategy',
          name: 'strategy',
        ...
        },
        {
          ...
          component: () => import('../views/UsefulCardIntroduction/StrategyDetail.vue')
        },
      ]
    },
    // 卡表介紹
    {
      ...
      children: [
        ...
        },
        {
          path: 'pack/:id',
          name: 'pack_detail',
          component: () => import('../views/ProductionInformation/PackDetail.vue')
        },
        {
          path: 'deck',
          name: 'deck',
        ...
        },
        {
          path: 'deck/:id',
          name: 'deck_detail',
          component: () => import('../views/ProductionInformation/DeckDetail.vue')
        },
        {
          path: 'rd',
          name: 'rd',
        ...
        },
        {
          path: 'rd/:id',
          name: 'rd_detail',
          component: () => import('../views/ProductionInformation/RdDetail.vue')
        },
        {
          path: 'box',
          name: 'box',
        ...
        },
        {
          path: 'box/:id',
          name: 'box_detail',
          component: () => import('../views/ProductionInformation/BoxDetail.vue')
        },
        {
          path: 'other',
          name: 'other',
        ...
        },
        {
          path: 'other/:id',
          name: 'other_detail',
          component: () => import('../views/ProductionInformation/OtherDetail.vue')
        },
      ]
    },
    // 規則相關
